...
export default function UserDashboard() {
  ...
  async function getParkingSpots(userLocation) {
                    ...
                    <div className="sidebar">
                        ...
                        <div class="home">
                            <div style={{"height":"60px"}}>
                                <input onChange={handleChange} style={{ "height": "40px" }} placeholder="Enter Location"/>
                                <button class="btn btn-primary" style={{"display":"inline-block", "marginLeft": "20px" }}onClick={handlerUserLocation}>Retrieve Parking Spots</button>
                            </div>
                                ...
                                (
                                    <div>
                                        ...
                                        <div class="featuredItem">
                                            <span class="featuredTitle">Available parking spots in this area: <b>{userSelectedLocation}</b></span>
